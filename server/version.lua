local resourceName = 'cb-crafting'
local currentVersion = GetResourceMetadata(resourceName, 'version', 0)
local versionUrl = 'https://raw.githubusercontent.com/cbytestudios/cb-crafting/main/cb-mining/version.txt'
...
Citizen.CreateThread(function()
    ...
    end, 'GET', '', { ['User-Agent'] = 'cb-crafting' })
end)